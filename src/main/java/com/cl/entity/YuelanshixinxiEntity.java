 ...
 */
@TableName("yuelanshixinxi")
public class YuelanshixinxiEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public YuelanshixinxiEntity() {
		
	}
	
	public YuelanshixinxiEntity(T t) {
		try {
	 ...
	 * 设置：座位设备
	 */
	public void setZuoweishebei(String zuoweishebei) {
		this.zuoweishebei = zuoweishebei;
	}
	/**
	 * 获取：座位设备
	 */
	public String getZuoweishebei() {
		return zuoweishebei;
	}
	/**
	 * 设置：座位位置
